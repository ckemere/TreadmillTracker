...
with open(args.output_dir + filename, 'w', newline='') as log_file:
    ...
    while(True):
        ...
        # #----------
        # if currentMazeState == MazeStates.SilentZones: 
        ...
        #         PinkNoiseStim.Play()
        #         currentMazeState = MazeStates.SilentZones
        # elif currentMazeState == MazeStates.ToneZone1:
        #     currentZoneState = ZoneSubstates.BetweenZone
        #     if currentZoneState = ZoneSubstates.BetweenZone:
        #         print('in between tone zone 1')
        #         PinkNoiseStim.Stop()
        #         ToneStim2.Stop()
        #         ToneStim3.Stop()
        #         ToneStim1.Play()
        ...
        #     # if currentZoneState == ZoneSubstates.PreZone:
        #     #     currentZoneState = ZoneSubstates.BetweenZone
        #     # elif currentZoneState == ZoneSubstates.BetweenZone
        #     #     print('in between tone zone 1')
        #     #     PinkNoiseStim.Stop()
        #     #     ToneStim2.Stop()
        #     #     ToneStim3.Stop()
        ...
        # elif (currentMazeState == MazeStates.SilentZones and ZoneDistance*3 < linear_pos % VirtualTrackDistance <= ZoneDistance*3 + ZoneDistance):
        #     if (MasterTime % 3000) == 0:
        #         print('in tone zone 2')
        #     PinkNoiseStim.Stop()
        #     ToneStim1.Stop()
        ...
        #     ToneStim2.Play()
        #     currentMazeState = MazeStates.ToneZone2
        # elif (currentMazeState == MazeStates.SilentZones and ZoneDistance*5 < linear_pos % VirtualTrackDistance <= ZoneDistance*5 + ZoneDistance):
        #     if (MasterTime % 3000) == 0:
        ...
        #     ToneStim3.Play()
        #     currentMazeState = MazeStates.ToneZone3
        # elif (currentMazeState == MazeStates.ToneZone2 and ZoneDistance*4 < linear_pos % VirtualTrackDistance <= ZoneDistance*4 + ZoneDistance):
        #     if (MasterTime % 3000) == 0:
        ...
        #     PinkNoiseStim.Play()
        #     currentMazeState = MazeStates.SilentZones
        #     if (currentMazeState == MazeStates.SilentZones and ZoneDistance*4 + SilentZoneDelay <= linear_pos % VirtualTrackDistance <= ZoneDistance*4 + SilentZoneDelay + ValidRewardZone):
        #         if (MasterTime % 1000) == 0:
        #             print('in REWARD zone...')
        #         # currentMazeState =  MazeStates.RewardZone
        #         ## operant condition, check if the mouse licked, if he did, then dispense water
        #         ## currenly he has to wait for LickTimeout amount of time (3s?) before he receives next water
        #         IsLicked = (GPIO & Well.LeftLickMask) == Well.LeftLickMask
        #         if CurrentLickState == MazeStates.NotLicked:
        ...
        #                 DelayEnd = MasterTime + LickTimeout
        #                 CurrentLickState = MazeStates.NotLicked
        #     # elif (currentMazeState == MazeStates.RewardZone and ZoneDistance*4 + SilentZoneDelay + ValidRewardZone < linear_pos % VirtualTrackDistance):
        #         # if (MasterTime % 1000) == 0:
        #             # print('EXIT REWARD zone.......')
        #         # currentMazeState =  MazeStates.SilentZones
        # elif currentMazeState in (MazeStates.ToneZone1, MazeStates.ToneZone3):
        # # else:
        #     if (MasterTime % 3000) == 0:
